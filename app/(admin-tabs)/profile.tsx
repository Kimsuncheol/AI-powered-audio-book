        ...
        <View style={styles.section}>
          ...
          <Pressable
            ...
            <View style={styles.menuItemLeft}>
              ...
              <ThemedText style={styles.menuItemText}>General Settings</ThemedText>
            </View>
          ...
          <Pressable
            ...
            onPress={() => Alert.alert('Coming Soon', 'This feature is coming soon!')}>
            <View style={styles.menuItemLeft}>
              <IconSymbol size={24} name="lock.shield.fill" color={colors.icon} />
          ...
          <Pressable
            ...
            onPress={() => Alert.alert('Coming Soon', 'This feature is coming soon!')}>
            <View style={styles.menuItemLeft}>
              <IconSymbol size={24} name="bell.badge.fill" color={colors.icon} />
