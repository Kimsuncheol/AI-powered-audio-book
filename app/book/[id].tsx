...
export default function BookDetailScreen() {
    ...
    return (
      <ThemedView style={styles.container}>
        <View style={styles.errorContainer}>
          <IconSymbol size={60} name="exclamationmark.triangle" color={colors.icon} />
  ...
  const handlePlay = () => {
    Alert.alert('Play Audiobook', 'Audio player coming soon!');
  };
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.bookHeader}>
          ...
          <View style={styles.metadata}>
            <View style={styles.metadataItem}>
              ...
              <ThemedText style={styles.metadataText}>{book.rating}</ThemedText>
            </View>
            <View style={styles.metadataItem}>
              <IconSymbol size={16} name="clock" color={colors.icon} />
              <ThemedText style={styles.metadataText}>{formatDuration(book.duration)}</ThemedText>
            </View>
            <View style={styles.metadataItem}>
              <IconSymbol size={16} name="book.closed" color={colors.icon} />
              <ThemedText style={styles.metadataText}>{book.chapters.length} chapters</ThemedText>
            </View>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.narratorCard, { backgroundColor: cardBgColor }]}>
            ...
            <View style={styles.narratorInfo}>
              <ThemedText style={styles.narratorName}>{book.narrator}</ThemedText>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <ThemedText style={styles.chapterCount}>{book.chapters.length} chapters</ThemedText>
          </View>
          {book.chapters.map((chapter, index) => (
            <Pressable
              ...
              style={[
                ...
                currentChapter === index && { borderColor: colors.tint, borderWidth: 2 },
              ]}
              onPress={() => {
              ...
              <View style={styles.chapterLeft}>
                <View
                  style={[
                    ...
                    currentChapter === index && { backgroundColor: colors.tint },
                  ]}>
                  <ThemedText
                    style={[
                      styles.chapterNumberText,
                      currentChapter === index && styles.chapterNumberTextActive,
                    ]}>
                    {index + 1}
                  </ThemedText>
                </View>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.ratingOverview, { backgroundColor: cardBgColor }]}>
              ...
              <View style={styles.stars}>
                {[1, 2, 3, 4, 5].map((star) => (
                  <IconSymbol
                    key={star}
                    size={16}
                    name={star <= Math.floor(book.rating) ? 'star.fill' : 'star'}
                    color="#FFD700"
                  />
                ))}
              </View>
            ...
            <Pressable
              ...
              onPress={() => Alert.alert('Write Review', 'Review feature coming soon!')}>
          ...
          <View style={[styles.reviewCard, { backgroundColor: cardBgColor }]}>
            <View style={styles.reviewHeader}>
              <View>
                <ThemedText style={styles.reviewAuthor}>Sarah Johnson</ThemedText>
                <View style={styles.reviewStars}>
                  {[1, 2, 3, 4, 5].map((star) => (
                    <IconSymbol key={star} size={12} name="star.fill" color="#FFD700" />
                  ))}
                </View>
              </View>
            ...
            <ThemedText style={styles.reviewText}>
              Absolutely captivating! The narrator brings the story to life beautifully. Couldn't stop listening.
            </ThemedText>
          </View>
          ...
          <View style={[styles.reviewCard, { backgroundColor: cardBgColor }]}>
            <View style={styles.reviewHeader}>
              <View>
                <ThemedText style={styles.reviewAuthor}>Michael Chen</ThemedText>
                <View style={styles.reviewStars}>
                  {[1, 2, 3, 4].map((star) => (
                    <IconSymbol key={star} size={12} name="star.fill" color="#FFD700" />
                  ))}
            ...
            <ThemedText style={styles.reviewText}>
              Great story and excellent narration. Highly recommend for anyone who enjoys this genre.
            </ThemedText>
          </View>
        </View>
