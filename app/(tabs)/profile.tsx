...
export default function ProfileScreen() {
  ...
  const handleExitGuestMode = async () => {
    Alert.alert('Exit Guest Mode', 'You will be returned to the welcome screen.', [
      {
        text: 'Cancel',
        style: 'cancel',
      },
      ...
      <ThemedView style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.header}>
            <View style={[styles.avatarContainer, { backgroundColor: colors.icon + '40' }]}>
              <IconSymbol size={50} name="person.fill" color={colors.icon} />
            </View>
            <ThemedText type="title" style={styles.name}>
              Guest User
            </ThemedText>
            <ThemedText style={styles.email}>Browsing in preview mode</ThemedText>
          </View>

          <View style={[styles.guestBanner, { backgroundColor: colors.tint + '20', borderColor: colors.tint }]}>
          ...
          <View style={styles.section}>
            <ThemedText style={styles.sectionTitle}>Features Requiring Sign Up</ThemedText>

            <View style={[styles.featureItem, { backgroundColor: cardBgColor }]}>
              <IconSymbol size={24} name="heart.fill" color={colors.icon} />
              <ThemedText style={styles.featureText}>Save favorite audiobooks</ThemedText>
            </View>

            <View style={[styles.featureItem, { backgroundColor: cardBgColor }]}>
              <IconSymbol size={24} name="chart.bar.fill" color={colors.icon} />
              <ThemedText style={styles.featureText}>Track listening progress</ThemedText>
            </View>

            <View style={[styles.featureItem, { backgroundColor: cardBgColor }]}>
              <IconSymbol size={24} name="play.circle.fill" color={colors.icon} />
              <ThemedText style={styles.featureText}>Unlimited playback access</ThemedText>
            </View>

            <View style={[styles.featureItem, { backgroundColor: cardBgColor }]}>
              <IconSymbol size={24} name="star.fill" color={colors.icon} />
              <ThemedText style={styles.featureText}>Write and share reviews</ThemedText>
            </View>

            <View style={[styles.featureItem, { backgroundColor: cardBgColor }]}>
              <IconSymbol size={24} name="icloud.fill" color={colors.icon} />
              <ThemedText style={styles.featureText}>Sync across all devices</ThemedText>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            >
              <ThemedText style={styles.createAccountText}>Create Free Account</ThemedText>
            </Pressable>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.menuItemLeft}>
                <IconSymbol size={24} name="rectangle.portrait.and.arrow.right" color={colors.icon} />
                <ThemedText style={styles.menuItemText}>Exit Guest Mode</ThemedText>
              </View>
            </Pressable>
          </View>
        </ScrollView>
