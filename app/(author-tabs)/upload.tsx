...
const GENRES = ['Fiction', 'Classic', 'Romance', 'Horror', 'Mystery', 'Fantasy', 'Science Fiction', 'Biography', 'Self-Help'];
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View style={styles.header}>
            ...
            <ThemedText style={styles.subtitle}>Share your audiobook with the world</ThemedText>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Pressable
              ...
              onPress={() => Alert.alert('Select Image', 'Image picker coming soon!')}>
              <IconSymbol size={40} name="photo" color={colors.icon} />
              <ThemedText style={styles.uploadText}>Tap to select cover image</ThemedText>
            </Pressable>
          </View>
          ...
          <View style={styles.section}>
            ...
            <TextInput
              style={[styles.textArea, { backgroundColor: inputBgColor, color: inputTextColor }]}
              ...
              {GENRES.map((genre) => (
                <Pressable
                  ...
                  style={[
                    ...
                    selectedGenres.includes(genre) && { backgroundColor: colors.tint },
                  ]}
          ...
          <View style={styles.section}>
            ...
            <Pressable
              ...
              onPress={() => Alert.alert('Upload Audio', 'Audio file upload coming soon!')}>
              <IconSymbol size={40} name="waveform" color={colors.icon} />
              <ThemedText style={styles.uploadText}>Tap to upload audio files</ThemedText>
              <ThemedText style={styles.uploadHint}>Supported: MP3, M4A, WAV (max 500MB per file)</ThemedText>
            </Pressable>
          </View>
