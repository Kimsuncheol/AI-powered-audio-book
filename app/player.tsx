...
import { GUEST_TIME_LIMIT, PLAYBACK_RATES } from "@/types/playback";
    ...
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.bookInfo}>
            ...
            {isGuest && (
              ...
              >
                ...
                <ThemedText
                  style={[styles.previewText, { color: colors.tint }]}
                >
          ...
          <View style={styles.controlsContainer}>
            ...
            >
              <IconSymbol
                ...
                color={
                  isGuest && playbackState.currentChapterIndex >= 0
                    ? colors.icon + "40"
                    : colors.text
                }
              />
          ...
          <View style={styles.secondaryControls}>
            ...
            >
              <IconSymbol
                ...
                color={
                  playbackState.isSleepTimerActive ? colors.tint : colors.text
                }
              />
            </Pressable>
          </View>
          ...
          {showPlaybackRates && (
            <View
              style={[styles.menuContainer, { backgroundColor: cardBgColor }]}
            >
            ...
            {book.chapters.map((chapter, index) => (
              <Pressable
                ...
                onPress={() => {
                  ...
                  Alert.alert(
                    "Coming Soon",
                    "Chapter selection will be available soon!",
                  );
                }}
              >
                <View style={styles.chapterItemLeft}>
                  ...
                  <View style={styles.chapterItemInfo}>
                    <ThemedText style={styles.chapterItemTitle}>
                      {chapter.title}
                    </ThemedText>
