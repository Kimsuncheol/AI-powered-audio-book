...
export const MOCK_AUDIOBOOKS: AudioBook[] = [
  {
    ...
    rating: 4.8,
    publishYear: 1813,
    audioUrl: 'https://www.archive.org/download/pride_prejudice_librivox/pride_prejudice_1_austen.mp3',
    chapters: [
      {
        id: 'ch1',
        title: 'Chapter 1',
  ...
  },
  {
    ...
    rating: 4.7,
    publishYear: 1925,
    audioUrl: 'https://www.archive.org/download/great_gatsby_librivox/gatsby_01_fitzgerald.mp3',
    chapters: [
      {
        id: 'ch1',
        title: 'Chapter 1',
  ...
  },
  {
    ...
    rating: 4.9,
    publishYear: 1865,
    audioUrl: 'https://www.archive.org/download/alices_adventures_librivox/alice_01_carroll.mp3',
    chapters: [
      {
        id: 'ch1',
  ...
  },
  {
    ...
    rating: 4.8,
    publishYear: 1892,
    audioUrl: 'https://www.archive.org/download/adventures_sherlock_holmes_librivox/adventures_01_doyle.mp3',
    chapters: [
      {
        id: 'ch1',
...
export function getProgressPercentage(currentPosition: number, totalDuration: number): number {
